...
#Before we pull out the data, we are going to transform the prices and predictions into a binary system.
#Generally, directionality of price is superior to predicting absolute price and this had been used in the Random Forest Generator Model.
#In order to compare the 2 models, we can convert both to a binary system.
